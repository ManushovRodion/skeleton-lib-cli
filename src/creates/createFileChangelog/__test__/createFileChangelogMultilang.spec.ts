...
import { createFileChangelogMultilang } from '../index';
import prettierConfig from '../../../../.prettierrc.json';

const DIR_TEST = './src/creates/createFileChangelog/__test__';
const PATH_FILE_RU = `${DIR_TEST}/CHANGELOG-RU.md`;
const PATH_FILE_EN = `${DIR_TEST}/CHANGELOG-EN.md`;
const PATH_FILE_TEST = `${DIR_TEST}/CHANGELOG-TEST.md`;
const PRETTER_CONFIG = prettierConfig as PrettierOptions;

describe('createFileChangelogMultilang', () => {
  it('Кидается исключение, когда неуказаны обязательные параметры', async () => {
    const file = createFileChangelogMultilang(PRETTER_CONFIG);
